  ...
  dependencies = {
    ...
    },
    {
      ...
      opts = function(_, opts)
        ...
        opts.mappings.n["]c"] = { "<Cmd>MoltenNext<CR><Cmd>normal! zz<CR>", desc = "Next Molten Cel" }
        opts.mappings.n["[c"] = { "<Cmd>MoltenPrev<CR><Cmd>normal! zz<CR>", desc = "Previous Molten Cell" }
      end,
    },
    {
